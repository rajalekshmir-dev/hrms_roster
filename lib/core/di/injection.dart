...
Future<void> init() async {
  ...
  sl.registerLazySingleton<AuthenticatedApiClient>(() => AuthenticatedApiClient(
    localDataSource: sl(),
  ...
  sl.registerLazySingleton(() => GetEmployeeDirectory(sl()));  // Note: No "UseCase"
  sl.registerLazySingleton(() => GetDepartmentStats(sl()));    // Note: No "UseCase"
